...
public class Pokerito {
    public static void main(String[] args) {
        ...
        System.out.println(" - The dealer will give each player a card.");
        ...
        scan.nextLine();
        System.out.println("The dealer will draw a cards every time the user presses enter.");
