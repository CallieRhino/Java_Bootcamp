...
public class RockPaperScissors {
    ...
    */
        ...
        if (play.equals("yes")) {
            ...
            String getComputerChoice = computerChoice();
            String outcome = result(choice, getComputerChoice);
            printResult(choice, getComputerChoice, outcome);
        } else {
            System.out.println("Darn it, what you doing here then?");
        }
